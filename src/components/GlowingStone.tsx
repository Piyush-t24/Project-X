...
interface GlowingStoneProps {
  ...
  phase: "approaching" | "colliding" | "circle" | "exploding" | "revealed";
...
export function GlowingStone({
  ...
  } else if (phase === "circle" && targetPosition) {
    currentPosition = new THREE.Vector3().lerpVectors(
      new THREE.Vector3(0, 0, 0),
      new THREE.Vector3(...targetPosition),
      Math.max(0, Math.min(1, circleProgress ?? 0))
    );
  } else {
    ...
    <group position={currentPosition.toArray()}>
      ...
      <mesh ref={meshRef}>
        ...
        <meshStandardMaterial
          ...
          emissive={color}
          emissiveIntensity={
            phase === "colliding" || phase === "circle" ? 1.0 : 0.5
          }
          metalness={0.1}
          roughness={0.2}
        />
