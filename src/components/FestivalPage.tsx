      ...
      <div className="relative z-10">
        ...
        <div className="h-screen w-full flex items-center justify-center">
          <div className="text-center px-4">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 tracking-wider">
              {festivalName}
            </h1>
            <div className="w-24 md:w-32 h-1 bg-gradient-to-r from-orange-400 to-red-500 rounded-full mx-auto mb-6"></div>
        ...
        <div className="h-screen w-full flex items-center justify-center">
          <div className="relative w-80 h-56 md:w-96 md:h-64 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl flex items-center justify-center">
