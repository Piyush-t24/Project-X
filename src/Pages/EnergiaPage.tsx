...
const stoneVideo = "/Energia/EnergiaStone.mp4";

// Image path for the 'About' section
const energiaPhoto = "/Images/energia1.png";
...
const techTalkImage = "/Images/e2.png";
const codingContestImage = "/Images/e3.png";
const roboticsImage = "/Images/ener.png";
const innovationImage = "/Images/sp.png";
const grungeTexture = "/Images/energia1.png";
...
const pastEvents: PastEvent[] = [
  {
    id: 1,
    title: "Tech Talks",
    description: "Expert insights into cutting-edge technology and innovation.",
    image: techTalkImage,
  },
  {
    id: 2,
    title: "Coding Contest",
    description: "Intense programming challenges for the brightest minds.",
    image: codingContestImage,
  },
  {
    id: 3,
    title: "Robotics Workshop",
    description: "Hands-on experience with advanced robotics and automation.",
    image: roboticsImage,
  },
  {
    id: 4,
    title: "Innovation Expo",
    description: "Showcasing groundbreaking projects and prototypes.",
...
const faqs: FAQ[] = [
  {
    ...
    answer:
      "Energia is RGIPT's premier technical festival focused on innovation, technology, and engineering excellence.",
  },
  {
    question: "When and where will Energia'25 take place?",
    answer:
...
export function EnergiaPage(): JSX.Element {
      ...
      <div className="relative z-10 flex-1 pointer-events-none">
          ...
          <div className="relative z-20 text-center max-w-4xl">
            <AnimatedHeading
              ...
              style={{
                ...
                textShadow:
                  "0 0 5px rgba(147, 51, 234, 0.9), 0 0 10px rgba(147, 51, 234, 0.7), 1px 1px 2px rgba(0,0,0,0.5)",
              }}
            />
            <div className="w-20 h-1 bg-gradient-to-r from-purple-400 to-purple-600 rounded-full mx-auto mb-4" />
            <p
              className="text-white/80 text-lg sm:text-xl"
              style={{ fontFamily: "'Times New Roman', Times, serif" }}
            >
              RGIPT's Premier Technical Festival
            </p>
          </div>
        ...
        <section className="h-screen w-full flex items-center justify-center px-6 overflow-hidden">
          <div className="max-w-6xl w-full mx-auto flex flex-col md:flex-row items-stretch justify-center gap-8">
            ...
            >
              <motion.div
                className="relative h-full p-2 rounded-3xl overflow-hidden bg-[rgba(147,51,234,0.1)] border-[3px] border-purple-500 shadow-purple-500/50 shadow-glow"
              ...
              >
                ...
                <div className="relative h-full flex items-center justify-center p-4 border-2 border-white/50 rounded-2xl z-10">
                  <img
                    src={energiaPhoto}
                    alt="A glimpse from a previous Energia event"
            ...
            >
              ...
              >
                ...
                <div className="relative h-full flex flex-col justify-center p-6 sm:p-8 border-2 border-white/50 rounded-2xl z-10">
                  <AnimatedHeading
                    text="About ENERGIA'25"
                    className="mb-4 text-4xl font-bold tracking-wide text-transparent sm:text-5xl bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600"
                    style={{
                      fontFamily: "'Times New Roman', Times, serif",
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Times New Roman', Times, serif" }}
                  >
                    Energia is RGIPT's premier technical festival that
                    celebrates innovation, technology, and engineering
                    excellence. This prestigious event brings together the
                    brightest minds from across the nation to showcase
                    cutting-edge projects, compete in challenging competitions,
                    and explore the frontiers of technology. Energia serves as a
                    platform where theoretical knowledge meets practical
                    application, fostering creativity and pushing the boundaries
                    of what's possible in the world of engineering and
                    technology.
                  </p>
                </div>
              </motion.div>
        ...
        <section className="h-screen w-full flex flex-col items-center justify-center py-16">
          <div className="text-center mb-12">
            <AnimatedHeading
              ...
              className="text-4xl sm:text-5xl font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600"
              style={{
                fontFamily: "'Times New Roman', Times, serif",
                filter: "drop-shadow(0 0 6px rgba(147, 51, 234, 0.7))",
              }}
            />
            <div className="w-20 h-1 bg-gradient-to-r from-purple-400 to-purple-600 rounded-full mx-auto mt-4" />
          </div>
          <div className="w-full pointer-events-auto">
            ...
            >
              {pastEvents.map((event) => (
                ...
                >
                  <div className="relative h-full p-2 rounded-3xl overflow-hidden bg-[rgba(147,51,234,0.1)] border-[3px] border-purple-500 shadow-purple-500/50 shadow-glow">
                    <div
                      className="absolute inset-0 z-0 bg-repeat opacity-10"
                      style={{ backgroundImage: `url(${grungeTexture})` }}
                    ></div>
        ...
        <section className="w-full py-20 px-6">
          <div className="relative max-w-4xl mx-auto p-2 rounded-3xl overflow-hidden bg-[rgba(147,51,234,0.1)] border-[3px] border-purple-500 shadow-purple-500/50 shadow-glow">
            <div
              className="absolute inset-0 z-0 bg-repeat opacity-10"
              style={{ backgroundImage: `url(${grungeTexture})` }}
            ></div>
            <div className="relative text-center p-8 sm:p-12 border-2 border-white/50 rounded-2xl z-10">
              <motion.h2
                ...
                className="text-4xl sm:text-5xl font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-purple-600 mb-4"
                style={{
                  fontFamily: "'Times New Roman', Times, serif",
                  filter: "drop-shadow(0 0 6px rgba(147, 51, 234, 0.7))",
                }}
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-purple-400 to-purple-600 rounded-full mx-auto" />
            ...
            <div className="relative text-center p-8 sm:p-12 border-2 border-white/50 rounded-2xl z-10">
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-block bg-gradient-to-r from-purple-500 to-purple-600 text-white font-bold text-lg py-4 px-8 rounded-full shadow-lg shadow-purple-500/30 transform hover:scale-105 transition-transform duration-300 ease-in-out pointer-events-auto"
                >
