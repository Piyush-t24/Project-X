...
const stoneVideo = "/Sauhardya/SauhardyaStone.mp4";

// Image path for the 'About' section
const sauhardyaPhoto = "/Images/cul.png";
...
const socialImpactImage = "/Images/cul.png";
const communityServiceImage = "/Images/cul.png";
const awarenessCampaignImage = "/Images/cul.png";
const volunteerWorkImage = "/Images/cul.png";
const grungeTexture = "/Images/cul.png";
...
const pastEvents: PastEvent[] = [
  {
    ...
    title: "Social Impact",
    description:
      "Creating meaningful change in communities through innovative solutions.",
  ...
  },
  {
    ...
    description:
      "Volunteer initiatives that make a real difference in people's lives.",
  ...
  },
  {
    ...
    description:
      "Spreading knowledge and awareness about important social issues.",
    image: awarenessCampaignImage,
  },
  {
    id: 4,
    title: "Volunteer Work",
    description:
      "Hands-on community engagement and social responsibility projects.",
...
const faqs: FAQ[] = [
  {
    question: "What is Sauhardya?",
    answer:
      "Sauhardya is RGIPT's social initiative festival focused on community service, social impact, and creating positive change in society.",
  },
  {
    question: "When and where will Sauhardya'25 take place?",
    answer:
...
export function SauhardyaPage(): JSX.Element {
      ...
      <div className="relative z-10 flex-1 pointer-events-none">
          ...
          <div className="relative z-20 text-center max-w-4xl">
            <AnimatedHeading
              ...
              style={{
                ...
                textShadow:
                  "0 0 5px rgba(251, 146, 60, 0.9), 0 0 10px rgba(251, 146, 60, 0.7), 1px 1px 2px rgba(0,0,0,0.5)",
              }}
            />
            <div className="w-20 h-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full mx-auto mb-4" />
            <p
              className="text-white/80 text-lg sm:text-xl"
              style={{ fontFamily: "'Times New Roman', Times, serif" }}
            >
              RGIPT's Social Initiative Festival
            </p>
          </div>
        ...
        <section className="h-screen w-full flex items-center justify-center px-6 overflow-hidden">
          <div className="max-w-6xl w-full mx-auto flex flex-col md:flex-row items-stretch justify-center gap-8">
            ...
            >
              <motion.div
                className="relative h-full p-2 rounded-3xl overflow-hidden bg-[rgba(251,146,60,0.1)] border-[3px] border-orange-500 shadow-orange-500/50 shadow-glow"
              ...
              >
                ...
                <div className="relative h-full flex items-center justify-center p-4 border-2 border-white/50 rounded-2xl z-10">
                  <img
                    src={sauhardyaPhoto}
                    alt="A glimpse from a previous Sauhardya event"
            ...
            >
              ...
              >
                ...
                <div className="relative h-full flex flex-col justify-center p-6 sm:p-8 border-2 border-white/50 rounded-2xl z-10">
                  <AnimatedHeading
                    text="About SAUHARDYA'25"
                    className="mb-4 text-4xl font-bold tracking-wide text-transparent sm:text-5xl bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600"
                    style={{
                      fontFamily: "'Times New Roman', Times, serif",
                  ...
                  <p
                    ...
                    style={{ fontFamily: "'Times New Roman', Times, serif" }}
                  >
                    Sauhardya is RGIPT's social initiative festival that
                    embodies the spirit of compassion, community service, and
                    social responsibility. This unique event brings together
                    students, faculty, and community members to work towards
                    creating positive social impact. Through various
                    initiatives, workshops, and community engagement programs,
                    Sauhardya aims to address real-world challenges and foster a
                    culture of empathy and social consciousness among the next
        ...
        <section className="h-screen w-full flex flex-col items-center justify-center py-16">
          <div className="text-center mb-12">
            <AnimatedHeading
              ...
              className="text-4xl sm:text-5xl font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600"
              style={{
                fontFamily: "'Times New Roman', Times, serif",
                filter: "drop-shadow(0 0 6px rgba(251, 146, 60, 0.7))",
              }}
            />
            <div className="w-20 h-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full mx-auto mt-4" />
          </div>
          <div className="w-full pointer-events-auto">
            ...
            >
              {pastEvents.map((event) => (
                ...
                >
                  <div className="relative h-full p-2 rounded-3xl overflow-hidden bg-[rgba(251,146,60,0.1)] border-[3px] border-orange-500 shadow-orange-500/50 shadow-glow">
                    <div
                      className="absolute inset-0 z-0 bg-repeat opacity-10"
                      style={{ backgroundImage: `url(${grungeTexture})` }}
                    ></div>
        ...
        <section className="w-full py-20 px-6">
          <div className="relative max-w-4xl mx-auto p-2 rounded-3xl overflow-hidden bg-[rgba(251,146,60,0.1)] border-[3px] border-orange-500 shadow-orange-500/50 shadow-glow">
            <div
              className="absolute inset-0 z-0 bg-repeat opacity-10"
              style={{ backgroundImage: `url(${grungeTexture})` }}
            ></div>
            <div className="relative text-center p-8 sm:p-12 border-2 border-white/50 rounded-2xl z-10">
              <motion.h2
                ...
                className="text-4xl sm:text-5xl font-bold tracking-wide text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600 mb-4"
                style={{
                  fontFamily: "'Times New Roman', Times, serif",
                  filter: "drop-shadow(0 0 6px rgba(251, 146, 60, 0.7))",
                }}
              ...
              <div className="w-20 h-1 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full mx-auto" />
            ...
            <div className="relative text-center p-8 sm:p-12 border-2 border-white/50 rounded-2xl z-10">
              ...
              <div className="mt-8">
                <a
                  ...
                  className="inline-block bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold text-lg py-4 px-8 rounded-full shadow-lg shadow-orange-500/30 transform hover:scale-105 transition-transform duration-300 ease-in-out pointer-events-auto"
                >
